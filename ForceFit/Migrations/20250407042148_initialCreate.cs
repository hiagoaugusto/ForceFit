        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PersonalID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NomePersonal = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonalID = table.Column<int>(type: "int", nullable: false),
                    AlunoID = table.Column<int>(type: "int", nullable: false),
                    NomeTreino = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TreinoExercios", x => new { x.ExerciciosExercicioID, x.TreinosTreinoID });
                    table.ForeignKey(
                        name: "FK_TreinoExercios_Exercicios_ExerciciosExercicioID",
                        column: x => x.ExerciciosExercicioID,
                        principalTable: "Exercicios",
                        principalColumn: "ExercicioID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TreinoExercios_Treinos_TreinosTreinoID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreinoExercios_TreinosTreinoID",
                table: "TreinoExercios",
